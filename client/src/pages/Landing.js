    ...
    <div className="flex flex-col items-center justify-center min-h-screen text-black py-7 bg-gradient-to-b from-mint-green to-light-blue">
      ...
      >
        ...
        <div className="flex justify-center mb-12">
          <Link to="/login" className="items-center justify-center px-6 py-3 text-lg font-semibold text-center text-white duration-300 rounded-md text-transition-colors bg-dark-purple hover:bg-marian-blue">
            Sign Up/Login
          </Link>
        </div>
